...
const Footer = () => {
    return (
        <>
            <footer className="footer footer-center p-10 bg-gradient-to-r from-cyan-500 to-blue-500 text-primary-content">
                <aside>
                    ...
                    <p className="font-bold">
                        Pet Transport BD <br />Providing reliable tech since 1992
                    </p>
