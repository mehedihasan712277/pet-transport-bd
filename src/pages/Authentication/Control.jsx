...
const Control = () => {
    ...
    return (
        <>
            <div className='pt-32 bg-gradient-to-r from-cyan-500 to-blue-500 min-h-screen w-full flex justify-center items-center'>
                <form onSubmit={handleAddProduct} className='bg-white w-fit flex flex-col gap-3 items-center px-6 py-8 shadow-2xl'>
                    <div>
